...
This directory is the canonical documentation entry point for Package Repository. The Infiltrator project family uses the same baseline document roles in every repository so readers can move between projects without relearning the structure.
